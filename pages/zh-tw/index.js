...
export default function ChineseTraditionalHome() {
  return (
    <>
      <Head>
        <title>鳴鳳堂 - 阿蘇文化度假村</title>
        <meta name="description" content="在熊本中心體驗沉浸式訓練和寧靜休憩。在鳴鳳堂體驗武術、傳統文化和日本待客之道。" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <link rel="canonical" href="https://meihodo.com/zh-tw" />
      ...
      <div dangerouslySetInnerHTML={{ __html: `
        <div id="blackout" aria-hidden="true">
          <div id="intro-phrase">靜靜地凝視自己的心。</div>
